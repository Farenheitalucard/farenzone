    ...
    <header className="navbar">
      <div className="navbar-inner" style={navStyle}>
        ...
        <nav className="nav-links">
          {elements.filter((e) => e.type !== 'social' && e.visible !== false && e.type === 'nav').map(renderElement)}
          ...
          {elements.filter((e) => e.type !== 'social' && e.visible !== false && e.type !== 'nav' && e.type !== 'consoles' && e.type !== 'menu' && e.type !== 'search').map(renderElement)}
          {elements.filter((e) => e.type !== 'social' && e.visible !== false && e.type === 'search').map(renderElement)}
        </nav>
      </div>
    </header>
  )
